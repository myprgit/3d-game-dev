...
public class HandgunScriptLPFP : MonoBehaviour
{
	...
	GameObject otherGun;
	GameObject uiTexts;
	GameObject thisGunText;
	GameObject otherGunText;
	...
	private void Awake()
	{
		...
		thisGun = gameObject;
		otherGun = thisGun.transform.parent.transform.GetChild(1).gameObject;
		uiTexts = thisGun.transform.parent.transform.GetChild(3).gameObject;
		thisGunText = uiTexts.transform.GetChild(5).gameObject;
		otherGunText = uiTexts.transform.GetChild(4).gameObject;
	}
	...
	private void Update()
	{
		...
		if (Input.GetKeyDown(KeyCode.Alpha2))
		{
			...
			thisGunText.SetActive(false);
			otherGunText.SetActive(true);
			totalAmmoText.text = otherGun.GetComponent<AutomaticGunScriptLPFP>().ammo.ToString();
		}
