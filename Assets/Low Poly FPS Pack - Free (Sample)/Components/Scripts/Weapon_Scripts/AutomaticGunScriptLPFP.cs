...
public class AutomaticGunScriptLPFP : MonoBehaviour
{
	...
	private void Awake()
	{
		...
		thisGun = gameObject;
		otherGun = thisGun.transform.parent.transform.GetChild(2).gameObject;
		uiTexts = thisGun.transform.parent.transform.GetChild(3).gameObject;
		thisGunText = uiTexts.transform.GetChild(4).gameObject;
		otherGunText = uiTexts.transform.GetChild(5).gameObject;
	}
	...
	private void Update()
	{
		...
		if (Input.GetKeyDown(KeyCode.Alpha2))
		{
			...
			totalAmmoText.text = otherGun.GetComponent<HandgunScriptLPFP>().ammo.ToString();
		}
